...
const seedFloridaCounties = async () => {
  try {
    console.log('Starting Florida counties seeding...');
    ...
    for (const countyData of floridaCounties) {
      ...
      console.log(`Created ${countyData.name} County (Processing: ${baseProcessingTime} days)`);
    }

    console.log(`Created ${createdCounties.length} Florida counties`);

    // Create checklists for each county
    console.log('Creating comprehensive checklists for Florida counties...');
    ...
    console.log('Florida counties seeding completed successfully!');
